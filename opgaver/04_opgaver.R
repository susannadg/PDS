...
# #3. Skriv en funktion, som tager en vektor som argument, og som beregner 
#   standardafvigelsen hvis n > 30, og ellers printer "N er under 30!" og afbryder (hint: `break`).
